...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u1 = User.signup("userabc", "abc@test.com", "passwordabc", None)
        self.u1_id = 1111
        self.u1.id = self.u1_id
        self.u2 = User.signup("userefg", "efg@test.com", "passwordefg", None)
        self.u2_id = 2222
        self.u2.id = self.u2_id
        self.u3 = User.signup("userhij", "hij@test.com", "passwordhij", None)
        self.u4 = User.signup("usertesting", "testing@test.com", "passwordtesting", None)
